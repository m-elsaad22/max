...
function maxart_promo_popup() {
	...
	echo '<style id="maxart-promo-css">#maxart-promo{position:fixed;inset:0;z-index:2147483000;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.58);padding:24px;box-sizing:border-box}#maxart-promo[hidden]{display:none!important}#maxart-promo .maxart-promo-card{position:relative;max-width:min(640px,92vw);width:100%;border-radius:18px;overflow:visible;box-shadow:0 18px 50px rgba(0,0,0,.45)}#maxart-promo a{display:block;line-height:0;border-radius:18px;overflow:hidden;background:#0b1d3a}#maxart-promo img{display:block;width:100%;height:auto}#maxart-promo .maxart-promo-close{position:absolute;top:8px;left:8px;width:38px;height:38px;border:0;border-radius:50%;background:#fff;color:#111;font-size:28px;line-height:38px;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,.3);z-index:2}#maxart-promo .maxart-promo-close:focus{outline:2px solid #fff;outline-offset:2px}</style>';
